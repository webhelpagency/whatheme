...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'       => 'https://webhelpagency.com/plugins/advanced-custom-fields-pro.zip', // The plugin source.
			'required'     => true, // If false, the plugin is only 'recommended' instead of required.
			'external_url' => 'https://webhelpagency.com', // If set, overrides default API URL and points to an external URL.
        ),
        
        array(
			'name'         => 'WP Rocket', // The plugin name.
			'slug'         => 'wp-rocket', // The plugin slug (typically the folder name).
			'source'       => 'https://webhelpagency.com/plugins/wp-rocket.zip', // The plugin source.
