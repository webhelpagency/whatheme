...
add_action( 'after_setup_theme', 'whatheme_woocommerce_support' );
if ( ! function_exists( 'whatheme_woocommerce_support' ) ) {
	/**
	 * Declares WooCommerce theme support.
	 */
	function whatheme_woocommerce_support() {
		...
		add_filter( 'woocommerce_form_field_args', 'whatheme_wc_form_field_args', 10, 3 );
	}
}
...
add_action( 'woocommerce_before_main_content', 'whatheme_woocommerce_wrapper_start', 10 );
add_action( 'woocommerce_after_main_content', 'whatheme_woocommerce_wrapper_end', 10 );

if ( ! function_exists( 'whatheme_woocommerce_wrapper_start' ) ) {
	/**
	 * Display the theme specific start of the page wrapper.
	 */
	function whatheme_woocommerce_wrapper_start() {
		$container = get_theme_mod( 'whatheme_container_type' );
...
if ( ! function_exists( 'whatheme_woocommerce_wrapper_end' ) ) {
	/**
	 * Display the theme specific end of the page wrapper.
	 */
	function whatheme_woocommerce_wrapper_end() {
		echo '</main><!-- #main -->';
		echo '</div><!-- .row -->';
...
if ( ! function_exists( 'whatheme_wc_form_field_args' ) ) {
	/**
	 ...
	 * @return mixed
	 */
	function whatheme_wc_form_field_args( $args, $key, $value = null ) {
...
if ( ! is_admin() && ! function_exists( 'wc_review_ratings_enabled' ) ) {
    ...
    /*
    Shortcodes are very important to include on your site in order for WooCommerce to function properly:
...
As an alternative, you can try WooCommerce Blocks instead of “Shortcode” Gutenberg element.
*/